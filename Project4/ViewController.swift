...
//  Project4
//
//  Created by Fırat Kahvecioğlu on 21.07.2022.
//
...
class ViewController: UIViewController, WKNavigationDelegate {
    ...
    func notAllowed()  {
        let alert = UIAlertController(title: "Alert", message: "This website not allowed", preferredStyle: UIAlertController.Style.alert)
